...
module.exports = {
  ...
  if(!member) return message.lineReply(embed.setDescription(`Bir kullanıcı belirtmelisin.`))
  let kanal = member.voice.channel
  if(!kanal) return message.lineReply(embed.setDescription(`Belirttiğin kişi ses kanalında bulunmuyor.`))
